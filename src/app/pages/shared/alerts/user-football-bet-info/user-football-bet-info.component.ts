...
import { GroupBet, IconModel, Icons, HistoryUserFootballBet, UserFootballBetInfo } from 'src/app/models/models';
...
@Component({
  selector: 'app-user-football-bet-info',
  templateUrl: './user-football-bet-info.component.html',
  styleUrls: [],
})
export class UserFootballBetInfoComponent implements OnInit{
   ...
   */
  public userBet:HistoryUserFootballBet[] = [];
   ...
   */
  public footballBet:GroupBet = null;
  ...
  /**
   * The full info for fill the alert info
   * 
   * @access public
   * @var {UserFootballBetInfo} info
   */
  @Input() info:UserFootballBetInfo;
  ...
  /**
   * Manage the object received by input
   * 
   * @OnInit
   */
  ngOnInit(){
    this.userBet = this.info.userBet;
    this.footballBet = this.info.footballBet;
    this.ended = this.info.ended;
  }
