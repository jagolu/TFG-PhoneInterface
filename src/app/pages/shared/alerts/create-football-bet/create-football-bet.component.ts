...
export class CreateFootballBetComponent{
   ...
   * 
   * @access public
   * @var {IonSelect} newBet_competitionSelect
   */
  @ViewChild('newBet_competitionSelect') newBet_competitionSelect: IonSelect;

  /**
   * The match select
   * 
   * @access public
   * @var {IonSelect} newBet_competitionMatches_select
   */
  @ViewChild('newBet_competitionMatches_select') newBet_competitionMatches_select: IonSelect;

  /**
   * The type bet select
   * 
   * @access public
   * @var {IonSelect} newBet_betType_select
   */
  @ViewChild('newBet_betType_select') newBet_betType_select: IonSelect;

  /**
   * The type pay select
   * 
   * @access public
   * @var {IonSelect} newBet_priceType_select
   */
  @ViewChild('newBet_priceType_select') newBet_priceType_select: IonSelect;

  /**
   * The allowed dates select
   * 
   * @access public
   * @var {IonSelect} newBet_allowedDates_select
   */
  @ViewChild('newBet_allowedDates_select') newBet_allowedDates_select: IonSelect;
   ...
   */
  public launchBet(){
    let date = this.newBet_allowedDates_select.value;
  ...
  public selectCompetition(){
    let competition = this.newBet_competitionSelect.value;
    ...
    if(!this.newBet_competitionMatches_launched){
      ...
      this.newBet_competitionMatches_select.value = 0;
    }
    this.resetForm();
  ...
  public selectMatchDay(){
    let matchday = this.newBet_competitionMatches_select.value;
    
    if(this.selectedMatch) this.newBet_betType_select.value = 0;
    this.resetForm();
   ...
   */
  public setBetType(){
    let typeid = this.newBet_betType_select.value;
   ...
   */
  public setPriceType(){
    let typeid = this.newBet_priceType_select.value;
  ...
  private addAllPriceType(betType:string){
    ...
    if(this.selectedPrice){
      this.newBet_priceType_select.value = 0;
